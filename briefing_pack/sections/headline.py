...
def _section_headline(
    ...
    lines.append("")
    lines.append("- **\"China\" includes Hong Kong and Macao.** European statistics report trade routed via ")
    lines.append("  Hong Kong and Macao under separate codes because they are separate customs territories; ")
